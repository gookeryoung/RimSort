    ...
    def apply_selected_theme(
        ...
        if enable_themes:
            ...
            if stylesheet:
                ...
                logger.warning(
                    f"Failed to apply theme: {selected_theme_name},Resetting to default theme: {self.default_theme}"
                )
                show_warning(
                    title=QCoreApplication.translate("ThemeController", "Theme Error"),
                    text=QCoreApplication.translate(
                        "ThemeController",
                        "Failed to apply theme: {selected_theme_name},Resetting to default theme: {self.default_theme}",
                    ).format(
